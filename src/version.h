...
namespace AutoVersion{
	...
	static const long REVISION  = 973;
	
	//Miscellaneous Version Types
	static const long BUILDS_COUNT  = 805;
	#define RC_FILEVERSION 1,91,14,973
	#define RC_FILEVERSION_STRING "1, 91, 14, 973\0"
	static const char FULLVERSION_STRING [] = "1.91.14.973";
