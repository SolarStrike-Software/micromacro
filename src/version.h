...
namespace AutoVersion{
	...
	static const long BUILDS_COUNT  = 2165;
	#define RC_FILEVERSION 1,99,2,1015
	#define RC_FILEVERSION_STRING "1, 99, 2, 1015\0"
	static const char FULLVERSION_STRING [] = "1.99.2.1015";
