...
namespace AutoVersion{
	...
	#define RC_FILEVERSION 1,91,41,1000
	#define RC_FILEVERSION_STRING "1, 91, 41, 1000\0"
	static const char FULLVERSION_STRING [] = "1.91.41.1000";
	
	//These values are to keep track of your versioning state, don't modify them.
	static const long BUILD_HISTORY  = 114;
