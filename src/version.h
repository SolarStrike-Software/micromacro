...
namespace AutoVersion{
	...
	#define RC_FILEVERSION 1,92,46,1005
	#define RC_FILEVERSION_STRING "1, 92, 46, 1005\0"
	static const char FULLVERSION_STRING [] = "1.92.46.1005";
	
	//These values are to keep track of your versioning state, don't modify them.
	static const long BUILD_HISTORY  = 119;
