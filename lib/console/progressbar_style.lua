...
function ConsoleProgressBarStyle:getFilledStyle(position, filledWidth, totalWidth)
...
function ConsoleProgressBarStyle:getUnfilledStyle(position, filledWidth, totalWidth)
...
function ConsoleProgressBarStyle:getFilledChar(position, filledWidth, totalWidth)
...
function ConsoleProgressBarStyle:getUnfilledChar(position, filledWidth, totalWidth)
...
function RainbowConsoleProgressBarStyle:getFilledStyle(position, filledWidth, totalWidth)
...
function OceanWaveConsoleProgressBarStyle:getFilledStyle(position, filledWidth, totalWidth)
